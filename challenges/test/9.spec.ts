...
import 'mocha';
import {runProgramme} from '../9';
import {runWithPermutation} from '../7';
import {consumeOpcodeAt, getParameterModes, getRealOpcode} from '../5';
...
describe('task 9', () => {
  ...
  it('runs a programme and gives expected output', () => {
    ...
    expect(runProgramme(testProgramme).programme).to.deep.equal([2, 0, 0, 0, 99]);
    const testProgramme2 = [2, 3, 0, 3, 99];
    expect(runProgramme(testProgramme2).programme).to.deep.equal([2, 3, 0, 6, 99]);
    const testProgramme3 = [2, 4, 4, 5, 99, 0];
    expect(runProgramme(testProgramme3).programme).to.deep.equal([2, 4, 4, 5, 99, 9801]);
    const testProgramme4 = [1, 1, 1, 4, 99, 5, 6, 0, 99];
    expect(runProgramme(testProgramme4).programme).to.deep.equal([30, 1, 1, 4, 2, 5, 6, 0, 99]);
    const testProgramme5 = [1002, 4, 3, 4, 33];
    expect(runProgramme(testProgramme5).programme).to.deep.equal([1002, 4, 3, 4, 99]);

    const testProgramme6 = [3, 0, 4, 0, 99];
    expect(runProgramme(testProgramme6, 5)).to.deep.equal({
      programme: [5, 0, 4, 0, 99],
      output: 5,
      halted: true,
      instruction: 4
    });
  ...
  it('handles negative numbers', () => {
    ...
    expect(runProgramme(testProgramme).programme).to.deep.equal([1101, 100, -1, 4, 99]);
  });

  it('handles opcode 5', () => {
    const testProgramme = [1105, 0, 3, 11101, 2, 7, 5, 99];
    expect(runProgramme(testProgramme).programme).to.deep.equal([1105, 0, 3, 11101, 2, 9, 5, 99]);
    const testProgramme2 = [1105, 4, 4, 0, 11101, 2, 7, 6, 99];
    expect(runProgramme(testProgramme2).programme).to.deep.equal([1105, 4, 4, 0, 11101, 2, 9, 6, 99]);
  });

  it('handles opcode 6', () => {
    const testProgramme = [1106, 0, 3, 11101, 2, 7, 5, 99];
    expect(runProgramme(testProgramme).programme).to.deep.equal([1106, 0, 3, 11101, 2, 9, 5, 99]);
    const testProgramme2 = [1106, 1, 3, 11101, 2, 7, 5, 99];
    expect(runProgramme(testProgramme2).programme).to.deep.equal([1106, 1, 3, 11101, 2, 9, 5, 99]);
    const testProgramme3 = [1106, 0, 7, 11101, 2, 7, 5, 99];
    expect(runProgramme(testProgramme3).programme).to.deep.equal([1106, 0, 7, 11101, 2, 7, 5, 99]);
  });

  it('handles opcode 7', () => {
    const testProgramme = [1107, 0, 3, 6, 11101, 2, 1, 7, 99];
    expect(runProgramme(testProgramme).programme).to.deep.equal([1107, 0, 3, 6, 11101, 2, 1, 3, 99]);
    const testProgramme2 = [1107, 3, 0, 6, 11101, 2, 1, 7, 99];
    expect(runProgramme(testProgramme2).programme).to.deep.equal([1107, 3, 0, 6, 11101, 2, 0, 2, 99]);
  });

  it('handles opcode 8', () => {
    const testProgramme = [1108, 3, 3, 6, 11101, 2, 1, 7, 99];
    expect(runProgramme(testProgramme).programme).to.deep.equal([1108, 3, 3, 6, 11101, 2, 1, 3, 99]);
    const testProgramme2 = [1108, 3, 0, 6, 11101, 2, 1, 7, 99];
    expect(runProgramme(testProgramme2).programme).to.deep.equal([1108, 3, 0, 6, 11101, 2, 0, 2, 99]);
  });
...
/*    const testProgramme6 = [3, 3, 1108, -1, 8, 3, 4, 3, 99];
  ...
  it('handles test input', () => {
    const programme = [109, 1, 204, -1, 1001, 100, 1, 100, 1008, 100, 16, 101, 1006, 101, 0, 99];
    /*  expect(runProgramme(programme).programme).to.deep.equal(programme);

      expect(runProgramme([1102,34915192,34915192,7,4,7,99,0]).output.toString()).to.be.length(16);
      expect(runProgramme([104,1125899906842624,99]).output).to.equal(1125899906842624);
  */

    const o = runProgramme([
      209, 9,
      21101, 5, 6, 0,
      4, 8,
      -1,
    ...
    console.log(o);
    expect(o.programme).to.deep.equal([209, 9, 21101, 5, 6, 0, 4, 8, 11, 8]);
